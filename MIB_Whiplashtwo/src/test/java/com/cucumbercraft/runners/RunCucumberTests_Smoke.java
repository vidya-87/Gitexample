...
@CucumberOptions(
		...
		features = "src/test/resources/features/", glue = { "com.cucumbercraft.stepdefinitions" }, tags = {
				"@login" }, monochrome = true, plugin = { "pretty", "pretty:target/cucumber-report/Smoke/pretty.txt",
...
public class RunCucumberTests_Smoke extends AbstractTestNGCucumberTests {
	...
	public static String mibNumber;
	public static String paymentNo;
	Properties properties = Settings.getInstance();
	static Logger log = Logger.getLogger(RunCucumberTests_Smoke.class);
