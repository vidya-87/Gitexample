 ...
 * fails.
 */
@CucumberOptions(features = "src/test/resources/features/prouser/poc.feature", glue = { "com.cucumbercraft.stepdefinitions" }, 
		monochrome = true, dryRun = false, /* tags= {"@prouser","~@failed"}, */ plugin = { "pretty", "pretty:target/cucumber-report/Regresssion/pretty.txt",
				"html:target/cucumber-report/Regresssion", "json:ta8rget/cucumber-report/Regresssion/cucumber.json",
...
public class RunCucumberTests_WhiplashRegression extends AbstractTestNGCucumberTests {

	static String resultFolder;
	Properties properties = Settings.getInstance();
	static Logger log = Logger.getLogger(RunCucumberTests_WhiplashRegression.class);
